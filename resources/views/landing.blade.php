...
<body class="font-sans antialiase">
   <x-navbar />
    ...
    <main id="hero" class="bg-transparent">
        <div class="bg-primary-800 min-h-screen mb-10 flex items-center relative pt-20 ">
            <div class="grid z-10 max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 grid-cols-1 lg:py-16 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7 text-white">
                    <h1
                        ...
                        Inovasi Terdepan untuk mendukung Pertumbuhan Bisnis Anda
                    </h1>
                    ...
                    <a href="#"
                        class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-primary-400 hover:bg-primary-500 focus:ring-4 focus:ring-primary-300">
                        Mulai Sekarang
                ...
                <div class="lg:mt-0 lg:col-span-5">
                    <div class="slider-carousel m-5 lg:m-0">
                        @php
                            $data = [1, 2, 3, 4, 5];
                        @endphp
                        @foreach ($data as $item)
                            <img src="https://via.placeholder.com/150" alt="placeholder" class="w-32 h-32 mx-auto">
                        @endforeach
                    </div>

                    <div class="grid grid-cols-3 gap-4 mt-8">
                        <a href="#" class="flex items-center justify-center p-4 text-white ">
                            Atna Consulting
                        </a>
                        <a href="#" class="flex items-center justify-center p-4 text-white ">
                            Atna Office
        ...
        {{-- MAPS --}}
        <div
            class="relative w-full max-w-screen-xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-6 py-8">
