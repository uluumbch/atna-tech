...
<body class="font-sans antialiased">
   <x-navbar />
    ...
    {{-- footer --}}
    <footer class="bg-primary-500 rounded-lg shadow m-4">
        <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            <div class="sm:flex sm:items-center sm:justify-between">
                {{-- follow us on --}}
                <div class="flex mt-4 sm:justify-center sm:mt-0">
                    <a href="#" class="text-gray-100 hover:text-gray-300 ms-5">
                    ...
                    <a href="#" class="text-gray-100 hover:text-gray-300  ms-5">
                        <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24"
                            fill="currentColor">
                            <title>TikTok</title>
                            <path
            ...
            <span class="block text-sm text-gray-100 sm:text-center ">
                Copy right PT Atna Mandiri Sentosa {{ date('Y') }}
            </span>
        </div>
    </footer>
    {{-- end footer --}}
