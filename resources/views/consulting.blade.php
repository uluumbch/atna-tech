...
@section('content')
    ...
    <section class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2  mx-auto w-max my-5">
            ...
            <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow flex flex-col items-center">
                <svg class="w-8 h-8 " width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="fill-primary-500" fill-rule="evenodd" clip-rule="evenodd" d="M26 6C26.5523 6 27 6.44772 27 7V10.0008C27 10.5531 27.4477 11.0008 28 11.0008C28.5523 11.0008 29 10.5531 29 10.0008V8H30C31.6569 8 33 9.34315 33 11V35C33 36.6569 31.6569 38 30 38H13C11.3431 38 10 36.6569 10 35V11C10 9.34315 11.3431 8 13 8H15V7C15 6.44772 15.4477 6 16 6C16.5523 6 17 6.44772 17 7V10.0008C17 10.5531 17.4477 11.0008 18 11.0008C18.5523 11.0008 19 10.5531 19 10.0008V8H25V7C25 6.44772 25.4477 6 26 6ZM15 18C14.4477 18 14 18.4477 14 19C14 19.5523 14.4477 20 15 20H28C28.5523 20 29 19.5523 29 19C29 18.4477 28.5523 18 28 18H15ZM14 24C14 23.4477 14.4477 23 15 23H22C22.5523 23 23 23.4477 23 24C23 24.5523 22.5523 25 22 25H15C14.4477 25 14 24.5523 14 24ZM15 28C14.4477 28 14 28.4477 14 29C14 29.5523 14.4477 30 15 30H26C26.5523 30 27 29.5523 27 29C27 28.4477 26.5523 28 26 28H15Z" fill="currentColor"></path>
                    <path d="M13 42C9.13401 42 6 38.866 6 35V10H8V35C8 37.7614 10.2386 40 13 40H30V42H13Z" fill="currentColor"></path>
                    <path d="M36 13C36 11.3431 37.3431 10 39 10C40.6569 10 42 11.3431 42 13V16H36V13Z" fill="currentColor"></path>
                    <path d="M36 33V18H42V33L39 37L36 33Z" fill="currentColor"></path>
                    </svg>
                <a href="#">
                    <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 ">
                        Apa fungsi KBLI?
